...
class SudokuGenerator:
    ...
    def is_valid(self, row, col, num):
        ...
        if row_validity == True and col_validity == True and box_validity == True:
            return True
        else:
            return False
    ...
    def fill_box(self, row_start, col_start):
        ...
        random.shuffle(nums)
        for row in range(0, self.box_length):
            for col in range(0, self.box_length):
                added_item = nums.pop(0)
                self.board[row_start + row][col_start + col] = added_item
    ...
    def fill_diagonal(self):
        for num in range(0, self.row_length, self.box_length):
